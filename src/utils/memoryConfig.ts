...
//     loginUrl: ` http://test.main.newrank.cn/user/login/m?type=121&source=181&backUrl=${encodeURIComponent(
...
//     loginUrl: ` http://newrank.cn/user/login/m?source=181&backUrl=${encodeURIComponent(
